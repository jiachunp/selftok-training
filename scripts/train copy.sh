...
torchrun \
  ...
  --dataset_config_file ./data/configs/example_selftok.yaml \
  --layer_module Qwen2_5_VLMoTDecoderLayer \
  --vl_path /data/ckpt/Qwen2.5VL/Qwen2.5-VL-3B-Instruct \
  --use_flex True \
  --results_dir ./output_pretrain \
  --checkpoint_dir ./ckpt_pretrain \
  ...
  --resume_from /data/zfd/SelfTok-o-main/ckpt_pretrain/0018500
