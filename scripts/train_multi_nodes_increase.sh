...
torchrun \
  ...
  train/pretrain_unified_vl_increase.py \
  ...
  --use_flex True \
  --results_dir ./output_path_imagenet_increase \
  --checkpoint_dir ./ckpt_path_imagenet_increase \
  --num_replicate $WORLD_SIZE \
  --num_workers 1 \
  --warmup_steps 1000 \
  --lr 1e-4 \
  --ema 0.9995 \
  --expected_num_tokens 61440 \
  --max_num_tokens 69120 \
  --max_num_tokens_per_sample 61440 \
  --auto_resume False \
  --log_every 10 \
  --save_every 2000
