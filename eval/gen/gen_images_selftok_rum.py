...
def generate_image(prompt, cfg_scale=10.0, num_images=4, do_sample=True, temperature=1.0, max_length=1024, device=None):
...
if __name__ == "__main__":
    ...
    for idx in range(start, end):
        ...
        # prompt = metadata.caption_enriched
