...
from eval.vlm.utils import load_selftok_o, build_transform, process_conversation
...
if __name__ == '__main__':
    ...
    model, tokenizer, new_token_ids, processor = load_selftok_o(args)
    ...
    # prompt = 'Answer the question using yes or no.'
    ...
    for filename in os.listdir(args.root):
        ...
        for line in tqdm(lines):
            ...
            # question = "please describe the image with 100 words"
