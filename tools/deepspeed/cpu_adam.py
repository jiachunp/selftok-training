...
class DeepSpeedCPUAdam(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        * AdamW: Fixing Weight Decay Regularization in Adam (https://arxiv.org/abs/1711.05101)
        ...
        default_args = dict(
            lr=lr, betas=betas, eps=eps, weight_decay=weight_decay, bias_correction=bias_correction, amsgrad=amsgrad
        )
        ...
        self.ds_opt_adam.create_adam(
            self.opt_id, lr, betas[0], betas[1], eps, weight_decay, adamw_mode, should_log_le("info")
        )
