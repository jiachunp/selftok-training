...
def attention(q, k, v, heads, mask=None):
    ...
    # if True:  # for debug!
        ...
        # q = q.transpose(1, 2).contiguous().view(-1, heads, dim_head)
        # k = k.transpose(1, 2).contiguous().view(q.shape[0], -1, dim_head)
        # v = v.transpose(1, 2).contiguous().view(q.shape[0], -1, dim_head)
